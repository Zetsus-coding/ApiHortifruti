...
public class ItemEntradaService : IItemEntradaService
{
    ...
    public async Task<IEnumerable<ItemEntrada>> ObterItensEntradaPorEntradaIdAsync(int entradaId)
    {
        return await _uow.ItensEntrada.ObterTodosDeUmaEntradaAsync(entradaId);
    }

}

// // Método redundante, removido em favor do controle feito pelo EF em EntradaService
